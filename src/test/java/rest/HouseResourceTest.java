...
public class HouseResourceTest {
    ...
    public void testServerIsUp() {
        ...
        given().when().get("/houses/all").then().statusCode(200);
    }
    ...
    void getAllHousesTest() {
        ...
        assertThat(houseDTOs, containsInAnyOrder(hdto1, hdto2, hdto3));
    }

    @Test
    void createHouseTest() {
        House house = new House("Lyngborgvej 7", "Kastrup", 5);

        HouseDTO newHdto = new HouseDTO(house);
        String requestBody = GSON.toJson(newHdto);
        ...
        given()
                ...
                .assertThat()
                .statusCode(200)
                .body("houseCity", equalTo("Kastrup"));
    }
}
